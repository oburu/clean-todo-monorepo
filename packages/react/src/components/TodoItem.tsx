...
const messageList = ['Yes, please', 'Sí, por favor', 'Sì grazie', "Oui s'il te plaît", 'はい'];

export const TodoItem = forwardRef<HTMLDivElement, { todo: Todo; isReordering: boolean }>(
  (props, ref) => {
    const [showDialog, setShowDialog] = useState(false);
    const acceptMessage = useRef(messageList[Math.floor(Math.random() * messageList.length)]);
    ...
    return (
      <div className="relative [perspective:1000px] h-14 w-full mb-2" ref={ref} {...rest}>
